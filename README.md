...
| | | | |
|---|---|---|---|
| ![title](docs/screenshots/title.png) | ![the opening](docs/screenshots/intro.png) | ![crisis](docs/screenshots/crisis.png) | ![the front page](docs/screenshots/paper.png) |

You are Odysseus. A new game opens on a page of where you stand — the
beach below Troy, the tenth year, and why any of it matters — and
then a crisis lands every scene, drawn: the island you are on and
what stands on it, the crew as so many men on the beach, the ship or
the raft or the wreckage, the sky as the gods' mood. You have 45
seconds to answer it; every answer pleases somebody and costs
